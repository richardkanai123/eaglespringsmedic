...
import BlogsHolder from '@/components/Dashboard/BlogComponents/BlogsHolder'
    ...
    <>
      ...
      <div className="flex w-full p-4 justify-center gap-4 align-middle items-center flex-col md:flex-row min-h-[50vh]">
        ...
        <section className='h-full w-full md:w-auto flex flex-col flex-1 items-center  justify-center p-2 gap-2'>
          ...
          <p className='text-xl font-[400] md:leading-snug text-justify leading-5 p-2'>
      ...
      <div className="w-full  dark:bg-slate-950 p-4 flex flex-col md:flex-row items-center justify-around mt-3 gap-4 min-h-[50vh] max-h-fit">
